...
import "@elklabs/baas/examples/ReservoirLockExample.sol";
import "@elklabs/baas/interfaces/IReservoir.sol";

contract XionReservoir is ReservoirLockExample {
    ...
    constructor(address _tokenAddress, address _realm, uint256 _txLimit) ReservoirLockExample(_tokenAddress, _realm, _txLimit) {}
